...
- Un chatbot ambiental (alcance confirmado por el diseño del equipo; **backend implementado el 2026-07-25** — `POST /chatbot`, OpenAI alimentado con los datos reales de los sensores; falta conectar la pantalla Flutter, ver `04-Arquitectura-Frontend.md` §8).
...
[ FRONTEND — Flutter, target principal web (ver 04-Arquitectura-Frontend.md §1) ]
  ...
  └── Chatbot            → backend listo (POST /chatbot, OpenAI); falta conectar la pantalla Flutter
